...
public class NewsActivity extends AppCompatActivity
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        ...
        uriBuilder.appendQueryParameter("api-key", "ea5d65d6-cf52-4a44-af38-e8462647574d");
        uriBuilder.appendQueryParameter("order-by", orderBy);
        uriBuilder.appendQueryParameter("show-fields", "all");
        uriBuilder.appendQueryParameter("page-size", maxNews);


        // Return the completed uri `https://content.guardianapis.com/search?show-tags=contributor&q=news&api-key=ea5d65d6-cf52-4a44-af38-e8462647574d"
